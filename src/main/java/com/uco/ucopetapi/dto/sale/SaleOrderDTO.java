...
public class SaleOrderDTO {
    ...
    public SaleOrderDTO(String orderNumber, LocalDateTime saleDate, Integer subtotal, Integer totalDiscount, Integer totalTaxes, Integer total, PaymentMethod paymentMethod, String comment, SaleOrderState state) {
