package com.uco.ucopetapi.controllers.invoice.exception;
...
@RestControllerAdvice(basePackages = "com.uco.ucopetapi.controllers.invoice")
public class InvoiceExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidation(InvoiceValidationException ex) {
        return buildResponse(HttpStatus.BAD_REQUEST, ex.getMessage());
    }

    @ExceptionHandler(InvoiceStateConflictException.class)
    public ResponseEntity<Map<String, Object>> handleStateConflict(InvoiceStateConflictException ex) {
    ...
    public ResponseEntity<Map<String, Object>> handleUnexpected(Exception ex) {
        log.error("Error inesperado procesando una solicitud de facturación", ex);
